...
namespace spec\Leifel\ForrestAdmin\Authentications;

use GuzzleHttp\ClientInterface;
use GuzzleHttp\Exception\RequestException;
use GuzzleHttp\Psr7\Request;
use GuzzleHttp\Psr7\Response;
use Leifel\ForrestAdmin\Exceptions\TokenExpiredException;
use Leifel\ForrestAdmin\Interfaces\EncryptorInterface;
use Leifel\ForrestAdmin\Interfaces\EventInterface;
...
class WebServerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Leifel\ForrestAdmin\Authentications\WebServer');
    }
        ...
        RepositoryInterface $mockedRefreshTokenRepo)
    {
        ...
        $mockedRefreshTokenRepo->get()->willThrow('\Leifel\ForrestAdmin\Exceptions\MissingRefreshTokenException');

        $this->shouldThrow('\Leifel\ForrestAdmin\Exceptions\MissingRefreshTokenException')->duringRequest('url', ['key' => 'value']);
    }
}
