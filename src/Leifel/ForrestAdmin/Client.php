...
namespace Leifel\ForrestAdmin;

use GuzzleHttp\ClientInterface;
use GuzzleHttp\Exception\RequestException;
use GuzzleHttp\Message\ResponseInterface;
use Leifel\ForrestAdmin\Exceptions\InvalidLoginCreditialsException;
use Leifel\ForrestAdmin\Exceptions\SalesforceException;
...
abstract class Client
{
     ...
     *
     * @var \Leifel\ForrestAdmin\Interfaces\InputInterface
     */
    protected $input;
     ...
     * Inteface for Input calls.
     *
     * @var \Leifel\ForrestAdmin\Interfaces\EncryptorInterface
     */
    protected $encryptor;
    ...
    private function handleRequest()
    {
        ...
        $this->event->fire('forrestadmin.response', [$formattedResponse]);
